...
class MedQADataset(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager) -> List[datasets.SplitGenerator]:
        ...
        if self.config.subset_id in ["med_qa_en", "med_qa_zh", "med_qa_tw"]:
            ...
            paths = {
                "train": os.path.join(base_dir, lang_path, "4_options/phrases_no_exclude_train.jsonl"),
                "test": os.path.join(base_dir, lang_path, "4_options/phrases_no_exclude_test.jsonl"),
                "valid": os.path.join(base_dir, lang_path, "4_options/phrases_no_exclude_dev.jsonl"),
            }
